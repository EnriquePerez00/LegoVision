...
def prepare_dataset():
    ...
    src_dir = os.path.join(project_root, "2camaras_random_pieza_unica", "data", "dinov2_refs_canonical_green")
    dst_dir = os.path.join(project_root, "camara_domo", "data", "efficientnet_train")
        ...
        for img_path in images:
            ...
            if len(parts) >= 2 and parts[0] == "ref":
                ...
                try:
                    ...
                    processed = preprocess_crop_grayscale(cropped)
