...
def estimate_color_mlp_features(img, mask_binary, camera_type=None, ccm_params=None):
        ...
        if hierarchical_clf is not None:
            for obs in obs_to_eval:
                ...
                if img_c is not None:
                    ...
                    feat_cen = estimate_color_mlp_features(img_c, mask_bin, "cenital", ccm_params)
