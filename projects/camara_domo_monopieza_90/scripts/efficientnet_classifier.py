...
class LegoEfficientNetClassifier:
    ...
    def _load_model(self, camera_type: str = 'cenital') -> nn.Module:
        ...
        if camera_type == 'cenital':
            weights_path = os.path.join(project_root_local, "models", "efficientnet_cenital_fine_tuned.pt")
        else:
            weights_path = os.path.join(project_root_local, "models", "efficientnet_lateral_fine_tuned.pt")
