...
class ColorClassifierAllColors:
    """
    ...
    def __init__(self, device=None):
        ...
        model_path = os.path.join(project_root, "models", "color_router_all_colors.pt")
        metadata_path = os.path.join(project_root, "models", "color_router_all_colors_metadata.json")
