...
def main():
    ...
    metadata_path = os.path.join(project_root, "data", "simulation_200_all", "simulation_metadata.json")
    ...
    if os.path.exists(cache_file):
        ...
        for idx, frame in enumerate(frames_list[::2]):
            f_name = frame["file_name"]
            f_name_lat = frame["file_name_frontal"]
            path_cen = os.path.join(project_root, "data", "simulation_200_all", f_name)
            path_lat = os.path.join(project_root, "data", "simulation_200_all", f_name_lat)
